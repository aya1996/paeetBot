                        ...
                        @foreach ($faqs as $key => $faq)
                            <tr>
                                ...
                                <td class="text-center">
                                    {!! \Illuminate\Support\Str::limit($faq->video, 20, '') !!}
                                </td>
                                <td class="text-center">
                                    @if($faq->image)
                                        <img src="{{asset($faq->image)}}" style="width:100px; height:100">
                                    @endif
                                </td>
                                <td class="text-center">
                                    ...
                                    <div class="modal fade" id="delete-modal{{$key}}">
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <form action="{{route('faqs.destroy' ,$faq->id )}}" method="POST" enctype="multipart/form-data" id="userForm">
                                                @csrf
                                                @method('DELETE')
